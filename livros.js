...
router.post("/", async (req, res) => {
    // faz a desestrututação dos dados recebidos no corpo da requisição
    ...
    // caso ocorra algum erri na inclusão, o programa irá capturar (catch) o erro
    try {
...
router.get("/dados/grafico", async (req, res) => {
    try {
        // obtém ano e soma do preco dos livros (com o nome total), agrupadps por ano
