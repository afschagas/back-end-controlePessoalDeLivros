...
exports.seed = function (knex) {
  ...
  .then(function () {
    return knex("livros").insert([
      {
        titulo: "Web Design Responsio", autor: "Maurício Samy Silva", ano: 2014,
      ...
      {
        titulo: "SQL em 10 Minutos por Dia", autor: "Bem Forta", ano: 2021,
        preco: 79.0, foto: "https://s3.novatec.com.br/capas/97865860578447.jpg",
      },
      {
